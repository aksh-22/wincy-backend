...
export const ServiceScehama = new mongoose.Schema(
  {
...
export const InvoiceSchema = new mongoose.Schema({
  ...
  paymentPhase: {type: mongoose.Types.ObjectId, ref: 'PaymentPhase', unique: true},
  ...
  services: [{type: ServiceScehama, default: undefined}],
